$(document).ready(function(){ 
  if (document.getElementById('keyGcChecked').value === "True") {
    document.getElementById('keyGc').checked = true;
  } else {
    document.getElementById('keyGc').checked = false;
  }
...
document.getElementById('constraints').addEventListener("change", function(e) {
  ...
  if (value == 'gcmotif') {
   ...
   // document.getElementById('keyGc').checked = true;
    //document.getElementById('keyGcChecked').value = "True"
}
  if (value == 'hairpin') {
...
function removeMotifGcContent() {
  ...
  document.getElementById('keyGcChecked').value = "False"
...
function changeKeyGc() {
  if (document.getElementById('keyGc').checked) {
    document.getElementById('keyGcChecked').value = "True";
  } else {
    document.getElementById('keyGcChecked').value = "False";
